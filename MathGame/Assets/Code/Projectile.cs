...
public class Projectile
{
    ...
    public void Render()
    {
        ...
        GUIUtility.RotateAroundPivot(DevMath.Vector2.Angle(new DevMath.Vector2(.0f, .0f), Direction), Position.ToUnityVector2());

        GUIUtility.ScaleAroundPivot(Vector2.one * SCALE, Position.ToUnityVector2());
